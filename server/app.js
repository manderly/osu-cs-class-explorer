...
/*
For development purposes, I use my own local copy of the OSU spreadsheet:
...
//This callback is only used when writing course data to a JSON file.
...
export function buildCourseData() {
  ...
  .catch(() => {
    return ('Error building spreadsheet data - could be a problem with Google Spreadsheet, your Google API credentials, or the packages used to access it.');
  });
}
